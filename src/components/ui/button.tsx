...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-xs hover:bg-terracotta-600",
        destructive:
        ...
        secondary:
          "bg-secondary text-secondary-foreground shadow-xs hover:bg-ivory-linen",
        ink: "bg-ink text-ivory shadow-xs hover:bg-ink-soft",
      ...
      size: {
        ...
        lg: "h-12 rounded-md px-8 text-[0.95rem] has-[>svg]:px-6",
